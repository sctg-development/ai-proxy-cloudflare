/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 1bfff1e26c9b5a77f4b62f61c797102d)
// Runtime types generated with workerd@1.20260518.1 2024-12-13 nodejs_compat
interface __BaseEnv_Env {
	KV_AI_PROXY: KVNamespace;
	PROXY_RATE_LIMITER: RateLimit;
	DEBUG: "false";
	FUFUNI_MERCHANT_URL: "";
	USAGE_DO: DurableObjectNamespace /* UsageDbDurableObject */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "UsageDbDurableObject";
	}
